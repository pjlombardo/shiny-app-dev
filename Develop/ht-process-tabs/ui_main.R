           ...
           navbarMenu("Step:",
            tabPanel("1. Set Null Hypothesis",
                    ...
                    tabPanel("2. Scale and shift",
                             fluidRow(
                                 column(12, 
                                        h2("Step 2: Transforming to t-units"),
                                        h3("Instructions:"),
                                        p("Here we use the formula to the right to transform our observed mean and the null sampling distribution into 't-units'")
                                 ),
                                 column(8,
